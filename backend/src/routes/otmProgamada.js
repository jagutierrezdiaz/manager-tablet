...
router.delete('/delete-supervisor-otm', otmProgramadaController.deleteSupervisorOtmController)
router.delete('/delete-firma-personal-otm', otmProgramadaController.deleteFirmaPersonalOtmController)
